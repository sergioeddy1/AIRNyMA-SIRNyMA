     ...
     document.addEventListener("DOMContentLoaded", async function () {
         ...
         if (btnMostrar && seccionProcesos) {
             btnMostrar.addEventListener("click", async function () {
                 ...
                 try {
                     const procesos = await fetch("https://invision-comparing-cheap-construct.trycloudflare.com/api/proceso").then(res => res.json());
                     const variables = await fetch("https://invision-comparing-cheap-construct.trycloudflare.com/api/variables").then(res => res.json());
