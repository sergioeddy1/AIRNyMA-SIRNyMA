...
async function getOdsIndicadoresCatalog() {
  ...
  try {
    const res  = await fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/ods_indicadores');
...
async function fetchOdsOnce() {
  ...
  const res = await fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/ods');
  const data = await res.json();
...
Promise.all([
  fetch("https://https://meeting-bacterial-window-schema.trycloudflare.com/api/proceso").then(r => r.json()),
  fetchProcesosEconomicas(),                 // procesosEco
  fetch("https://https://meeting-bacterial-window-schema.trycloudflare.com/api/variables").then(r => r.json()),
  fetchVariablesDesdeUltima(),               // ← variablesUltima (económicas mapeadas)
  fetch("https://https://meeting-bacterial-window-schema.trycloudflare.com/api/eventos").then(r => r.json()),
  fetch("https://https://meeting-bacterial-window-schema.trycloudflare.com/api/clasificaciones").then(r => r.json())
])
  ...
  initTooltips();
    ...
    // Carga perezosa de chips MDEA cuando no vienen embebidos
      ...
      async function fetchMdeaOnce() {
        ...
        const res = await fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/mdea');
        const data = await res.json();
...
document.addEventListener("click", async function (e) {
  ...
  try {
    ...
    const resVarTab = await fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/var-tab');
    ...
    const resTabulados = await fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/tabulado');
  ...
  try {
    ...
    const res = await fetch(`https://https://meeting-bacterial-window-schema.trycloudflare.com/api/microdatos`);
    const data = await res.json();
...
if (e.target.closest(".mdea-chip")) {
  ...
  (async () => {
    try {
      ...
      //    SOCIODEMOGRÁFICAS
      // ========================
      const all = await fetch("https://https://meeting-bacterial-window-schema.trycloudflare.com/api/mdea")
        .then((r) => r.json())
...
if (e.target.closest(".badge-ods")) {
  ...
  try {
    ...
    const [resOds, resIndic, resMeta] = await Promise.all([
      fetch(`https://https://meeting-bacterial-window-schema.trycloudflare.com/api/ods`),
      fetch(`https://https://meeting-bacterial-window-schema.trycloudflare.com/api/ods_indicadores`), // catálogo indicadores
      fetch(`https://https://meeting-bacterial-window-schema.trycloudflare.com/api/meta_ods`)         // catálogo metas
    ]);
...
fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/clasificaciones')
  .then(res => res.json())
  .then(clasificaciones => {
    clasificacionesGlobal = clasificaciones;
    return fetch('https://https://meeting-bacterial-window-schema.trycloudflare.com/api/eventos').then(res => res.json());
  })
  .then(eventos => {
