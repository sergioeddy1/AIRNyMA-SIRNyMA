...
async function getOdsIndicadoresCatalog() {
  ...
  try {
    const res  = await fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/ods_indicadores');
  ...
  async function fetchVariablesDesdeUltima() {
    const urlUltima = "https://readers-bodies-independent-lexmark.trycloudflare.com/api/indicadores/ultima";
...
function hasDatosAbiertos(variable) {
  ...
  async function fetchProcesosEconomicas() {
    const urlProcesosEco = "https://readers-bodies-independent-lexmark.trycloudflare.com/api/procesos/buscar?unidad=" +
...
async function fetchOdsOnce() {
  ...
  const res = await fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/ods');
  const data = await res.json();
...
Promise.all([
  fetch("https://subtle-planner-building-vincent.trycloudflare.com/api/proceso").then(r => r.json()),
  fetchProcesosEconomicas(),                 // procesosEco
  fetch("https://subtle-planner-building-vincent.trycloudflare.com/api/variables").then(r => r.json()),
  fetchVariablesDesdeUltima(),               // ← variablesUltima (económicas mapeadas)
  fetch("https://subtle-planner-building-vincent.trycloudflare.com/api/eventos").then(r => r.json()),
  fetch("https://subtle-planner-building-vincent.trycloudflare.com/api/clasificaciones").then(r => r.json())
])
  ...
  initTooltips();
    ...
    // Carga perezosa de chips MDEA cuando no vienen embebidos
      ...
      async function fetchMdeaOnce() {
        ...
        const res = await fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/mdea');
        const data = await res.json();
...
document.addEventListener("click", async function (e) {
  ...
  try {
    ...
    const resVarTab = await fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/var-tab');
    ...
    const resTabulados = await fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/tabulado');
  ...
  try {
    ...
    const res = await fetch(`https://subtle-planner-building-vincent.trycloudflare.com/api/microdatos`);
    const data = await res.json();
...
if (e.target.closest(".mdea-chip")) {
  ...
  (async () => {
    try {
      ...
      //    SOCIODEMOGRÁFICAS
      // ========================
      const all = await fetch("https://subtle-planner-building-vincent.trycloudflare.com/api/mdea")
        .then((r) => r.json())
...
if (e.target.closest(".badge-ods")) {
  ...
  try {
    ...
    const [resOds, resIndic, resMeta] = await Promise.all([
      fetch(`https://subtle-planner-building-vincent.trycloudflare.com/api/ods`),
      fetch(`https://subtle-planner-building-vincent.trycloudflare.com/api/ods_indicadores`), // catálogo indicadores
      fetch(`https://subtle-planner-building-vincent.trycloudflare.com/api/meta_ods`)         // catálogo metas
    ]);
...
fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/clasificaciones')
  .then(res => res.json())
  .then(clasificaciones => {
    clasificacionesGlobal = clasificaciones;
    return fetch('https://subtle-planner-building-vincent.trycloudflare.com/api/eventos').then(res => res.json());
  })
  .then(eventos => {
