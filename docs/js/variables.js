...
async function getOdsIndicadoresCatalog() {
  ...
  async function fetchVariablesDesdeUltima() {
    const urlUltima = "https://need-planets-authors-worm.trycloudflare.com/api/indicadores/ultima";
...
function hasDatosAbiertos(variable) {
  ...
  async function fetchProcesosEconomicas() {
    const urlProcesosEco = "https://need-planets-authors-worm.trycloudflare.com/api/procesos/buscar?unidad=" +
...
async function fetchOdsOnce() {
  ...
  const res = await fetch('https://desire-toner-diagnosis-concentration.trycloudflare.com/api/ods');
  const data = await res.json();
...
Promise.all([
  fetch("https://desire-toner-diagnosis-concentration.trycloudflare.com/api/proceso").then(r => r.json()),
  fetchProcesosEconomicas(),                 // procesosEco
  fetch("https://desire-toner-diagnosis-concentration.trycloudflare.com/api/variables").then(r => r.json()),
  fetchVariablesDesdeUltima(),               // ← variablesUltima (económicas mapeadas)
  fetch("https://desire-toner-diagnosis-concentration.trycloudflare.com/api/eventos").then(r => r.json()),
  fetch("https://desire-toner-diagnosis-concentration.trycloudflare.com/api/clasificaciones").then(r => r.json())
])
  ...
  initTooltips();
    ...
    // Carga perezosa de chips MDEA cuando no vienen embebidos
      ...
      async function fetchMdeaOnce() {
        ...
        const res = await fetch('https://desire-toner-diagnosis-concentration.trycloudflare.com/api/mdea');
        const data = await res.json();
...
document.addEventListener("click", async function (e) {
  ...
  try {
    ...
    const resVarTab = await fetch('https://desire-toner-diagnosis-concentration.trycloudflare.com/api/var-tab');
    ...
    const resTabulados = await fetch('https://desire-toner-diagnosis-concentration.trycloudflare.com/api/tabulado');
  ...
  try {
    ...
    const res = await fetch(`https://desire-toner-diagnosis-concentration.trycloudflare.com/api/microdatos`);
    const data = await res.json();
...
if (e.target.closest(".mdea-chip")) {
  ...
  (async () => {
    try {
      ...
      //    SOCIODEMOGRÁFICAS
      // ========================
      const all = await fetch("https://desire-toner-diagnosis-concentration.trycloudflare.com/api/mdea")
        .then((r) => r.json())
